...
if __name__ == "__main__":
    ...
    print("NLU TEST")
    nlu = HandcraftedNLU(domain=JSONLookupDomain(name='Bars', # domain name
                                                json_ontology_file='resources/ontologies/Bars.json', # path to ontology, relative to adviser folder
                                                sqllite_db_file='resources/databases/bars.db', # path to sqlite database, relative to adviser folder
                                                display_name='Bars Domain')) # human-readable name of the domain
    user_input = None
